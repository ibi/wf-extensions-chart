...
(function () {
    ...
    function drawLiquidGauge(elementId, value, chart) {
        var config = this;
        ...
        var textFormatter = function (value) {
            var _value = value;
            if (chart?.formatNumber && chart?.dataBuckets?.getBucket('value')?.fields[0]?.numberFormat) _value = chart.formatNumber(value, chart.dataBuckets.getBucket('value').fields[0].numberFormat);
            return _value;
        };
        ...
        var text1 = gaugeGroup
            .append('text')
            .text(textFormatter(textRounder(textStartValue)) + percentText)
        ...
        if (config.valueCountUp) {
            var textTween = function () {
                ...
                return function (t) {
                    var _value = textRounder(i(t)),
                        _formated = textFormatter(_value);
                    this.textContent = _formated + percentText;
                };
            };
