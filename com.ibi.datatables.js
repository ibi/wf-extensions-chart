...
(function() {
	...
	function renderCallback(renderConfig) {
		...
		if (dataJSON.length>0){
			...
			/* Data Row Style */
			$(container).find('#ib-inline-style').append('.table>tbody>tr>td{font-weight:'+props.data.fontWeight+';color:'+props.data.color+'}\n');
			$(container).find('#ib-inline-style').append('.table>tbody>tr.odd{background-color:'+props.data.backgroundColorOdd+'}\n');
			$(container).find('#ib-inline-style').append('.table>tbody>tr.even{background-color:'+props.data.backgroundColorEven+'}\n');
