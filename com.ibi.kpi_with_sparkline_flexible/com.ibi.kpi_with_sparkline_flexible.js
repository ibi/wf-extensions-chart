...
(function() {
	...
	function renderCallback(renderConfig) {
		...
		if (typeof data[0].measure !== 'undefined'||typeof data[0].xaxis !== 'undefined') {
			...
			if (props.squareDesign == true) {
				...
				$(container).css('top',titleHeight+'px').append('<div class="kpi-container-sq" style="font-family:'+props.fontFamily+';font-size:'+props.fontSize+';color:'+props.color+'"></div>');
				// fill containers on html page - 1st line
				$(container).find('.kpi-container-sq').append('<div><div class="kpi-title-sq" style="font-weight:'+props.measureName.fontWeight+';font-size:'+props.measureName.fontSize+';color:'+props.measureName.color+'">' + title + '</div></div>');
				// fill containers on html page - 2nd line
				$(container).find('.kpi-container-sq').append('<div><div class="kpi-total-sq" style="font-weight:'+props.total.fontWeight+';font-size:'+props.total.fontSize+';color:'+props.total.color+'">' + total1 + '</div></div>');
				// fill containers on html page - 3rd line
				if (props.deviationVsPrevious.disableDeviation == true) {
				}
				else {
					$(container).find('.kpi-container-sq').append('<div><div class="kpi-change-sq" style="font-size:'+props.deviationVsPrevious.fontSize+';color:'+props.deviationVsPrevious.color+'">'+percentChange+'</div></div>');
				}
				...
				$(container).css('top',titleHeight+'px').append('<div class="kpi-container" style="font-family:'+props.fontFamily+';font-size:'+props.fontSize+';color:'+props.color+'"></div>');
				// fill containers on html page - 1st line
				if (props.deviationVsPrevious.disableDeviation == true) {
					$(container).find('.kpi-container').append('<div><div class="kpi-title-no-change" style="font-weight:'+props.measureName.fontWeight+';font-size:'+props.measureName.fontSize+';color:'+props.measureName.color+'">' + title + '</div></div>');
				}
				else {
					$(container).find('.kpi-container').append('<div><div class="kpi-title" style="font-weight:'+props.measureName.fontWeight+';font-size:'+props.measureName.fontSize+';color:'+props.measureName.color+'">' + title + '</div><div class="kpi-change" style="font-size:'+props.deviationVsPrevious.fontSize+';color:'+props.deviationVsPrevious.color+'">'+percentChange+'</div></div>');
				}
				// fill containers on html page - 2nd line			
				if (props.barProperties.disableSparklineChart == true) {
					$(container).find('.kpi-container').append('<div><div class="kpi-total" style="font-weight:'+props.total.fontWeight+';font-size:'+props.total.fontSize+';color:'+props.total.color+'">' + total1 + '</div></div>');
				}
				else {
					$(container).find('.kpi-container').append('<div><div class="kpi-total" style="font-weight:'+props.total.fontWeight+';font-size:'+props.total.fontSize+';color:'+props.total.color+'">' + total1 + '</div><div class="kpi-sparkline"></div></div>');
	...
	function noDataRenderCallback(renderConfig) {
		...
		renderConfig.data = [{"xaxis":"1","measure":35861466.38,"_s":0,"_g":0},{"xaxis":"2","measure":32447335.21,"_s":0,"_g":1},{"xaxis":"3","measure":35431268.47,"_s":0,"_g":2},{"xaxis":"4","measure":32401840.77,"_s":0,"_g":3},{"xaxis":"5","measure":33927910.25,"_s":0,"_g":4},{"xaxis":"6","measure":32732103.34,"_s":0,"_g":5},{"xaxis":"7","measure":33867267.96,"_s":0,"_g":6},{"xaxis":"8","measure":34030687.74,"_s":0,"_g":7},{"xaxis":"9","measure":33129035.69,"_s":0,"_g":8},{"xaxis":"10","measure":41468698.51,"_s":0,"_g":9},{"xaxis":"11","measure":41330631.98,"_s":0,"_g":10},{"xaxis":"12","measure":45063421.35,"_s":0,"_g":11}];
		renderConfig.dataBuckets = {"buckets":{"xaxis":{"title":"Sale Month","count":1},"measure":{"title":"Revenue","count":1}},"depth":1};
