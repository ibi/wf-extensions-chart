	...
	function renderCallback(renderConfig) {
		...
		if (typeof data[0].measure !== 'undefined' && typeof data[0].xaxis !== 'undefined') {
			...
			groups.forEach(function(group, index){
				...
				+ '<th class="kpi-table-heading-nbr" style="font-weight:'+props.headingData.fontWeight+';font-size:'+props.headingData.fontSize+';color:'+props.headingData.color+'">'+abbreviateNumber(group.total)+'</th></tr>'
				+ '</thead>'
		...
		//Begin CD-720
			...
			*/
			...
			function fnShowNoDataMsg(container,properties) {
				...
				divMsg.style.cssText = "margin-top:100px; font-family: sans-serfif;  text-align: center; fill: black; opacity: 0.8; font-weight: bold; font-size: 14px;";			
